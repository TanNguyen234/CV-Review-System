...
class CVTextCleaner:
    ...
    def __init__(self):
        ...
        self.section_mapping = {
            "OBJECTIVE": ["OBJECTIVE", "SUMMARY", "EXECUTIVE SUMMARY", "PROFILE", "ABOUT ME"],
            "SKILLS": ["SKILLS", "AREAS OF EXPERTISE", "TECHNICAL SKILLS", "COMPETENCIES", "CORE COMPETENCIES"],
            "EXPERIENCE": ["EXPERIENCE", "WORK EXPERIENCE", "EMPLOYMENT HISTORY", "PROFESSIONAL EXPERIENCE", "WORK HISTORY"],
            "EDUCATION": ["EDUCATION", "ACADEMIC BACKGROUND", "QUALIFICATIONS"],
            "PROJECTS": ["PROJECTS", "PERSONAL PROJECTS", "PRODUCT PORTFOLIO", "KEY PROJECTS"],
            "CERTIFICATIONS": ["CERTIFICATIONS", "AWARDS", "CERTIFICATES"]
        }
